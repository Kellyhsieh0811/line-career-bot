...
_PRICE_QUESTION = (
    ...
    "很多找我的人，在這個階段都還沒把真正卡住的點想清楚，\n"
    "而這正是一對一最值得的地方——\n"
    "幫你把方向、履歷或面試策略一起釐清，讓你知道最值得先動的是哪一步。\n\n"
    "如果你有需要，我可以幫你看看適不適合你現在的狀況 😊"
)

_JOB_OPENING_FIRST = (
    "想找好工作，這完全可以理解！😊\n\n"
    "我這邊做的方式稍微不一樣——\n"
    "不是直接提供職缺，而是幫你先把方向跟履歷整清楚，\n"
    "讓你投出去的每一份都更精準、更有競爭力。\n\n"
    "很多人從這裡出發，最後找到的機會比原本預期的還要好。\n\n"
    "你現在最想先解決的是哪一塊？"
)
